    ...
    <div class="max-w-[280px] mx-auto">
        <div class="flex flex-col items-center mt-[10vh]">
            ...
            <button
                ...
                <span class="text-gray-700 font-medium">Continiar con Google</span>
            </button>
            ...
            <form>
                ...
                <button
                    class="bg-slate-500 hover:bg-slate-700 text-white text-base rounded-lg py-2.5 px-5 transition-colors w-full text-[19px]">Iniciar
                    sesion</button>
            </form>
